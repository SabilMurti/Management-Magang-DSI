            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-4">
                    @if($intern->user->avatar)
                        <img src="{{ asset('storage/avatars/' . $intern->user->avatar) }}" alt="{{ $intern->user->name }}"
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="card p-5 border border-indigo-100 bg-indigo-50/50">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="text-2xl font-black text-indigo-900">{{ $stats['completedTasks'] }} <span class="text-sm font-medium text-indigo-400">/ {{ $stats['totalTasks'] }}</span></div>
            ...
            <div class="card p-5 border border-emerald-100 bg-emerald-50/50">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="text-2xl font-black text-emerald-900">{{ $stats['attendancePercentage'] }}<span class="text-lg">%</span></div>
            ...
            <div class="card p-5 border border-sky-100 bg-sky-50/50">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="text-2xl font-black text-sky-900">{{ $stats['averageSpeed'] }}<span class="text-lg">%</span></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="card h-full">
                ...
                <div class="space-y-5">
                    ...
                    <div class="group">
                        <label class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1 block">No. Telepon</label>
                        <div class="text-sm font-semibold text-slate-700 flex items-center gap-2">
                    ...
                    <div class="group">
                        <label class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1 block">Pembimbing</label>
                        <div class="text-sm font-semibold text-slate-700 flex items-center gap-2">
                            <i class="fas fa-chalkboard-teacher text-slate-300 w-5"></i> {{ $intern->supervisor->name ?? '-' }}
                        </div>
                    </div>
                    <div class="group">
            ...
            <div class="lg:col-span-2 space-y-6">
                <!-- Quick Actions -->
                <div class="card p-5 bg-gradient-to-r from-violet-500 to-fuchsia-600 text-white border-0 shadow-lg shadow-violet-500/20">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="card min-h-[320px] flex flex-col">
                        <div class="card-header border-b border-slate-100 pb-3 mb-3">
                            <h3 class="card-title font-bold text-slate-700 text-sm"><i class="fas fa-chart-pie text-violet-500 mr-2"></i> Status Tugas</h3>
                        </div>
                    ...
                    <div class="card min-h-[320px] flex flex-col">
                        <div class="card-header border-b border-slate-100 pb-3 mb-3">
                            <h3 class="card-title font-bold text-slate-700 text-sm"><i class="fas fa-user-clock text-emerald-500 mr-2"></i> Kehadiran</h3>
                        </div>
                        <div class="flex-1 relative">
