    ...
    <div class="page">
        ...
        <div class="profile-section">
            ...
            <div class="progress-section">
                <div class="progress-label">Progress Magang: {{ $progress }}% ({{ $daysCompleted }} dari {{ $duration }}
                    hari)</div>
        ...
        <div class="two-column">
            <div class="column">
                ...
                <div class="info-box" style="border-color: #10b981;">
                    ...
                    <div class="info-box-value" style="color: #10b981;">{{ $taskStats['on_time'] }}</div>
                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif($task->status === 'completed')
                                <span style="color: #10b981;">Tepat</span>
                            @else
                                -
                            @endif
                        </td>
