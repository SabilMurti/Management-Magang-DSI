<div class="slide-up max-w-5xl mx-auto space-y-5">
    ...
    <div class="card overflow-hidden p-0">
        <form wire:submit="save">
            ...
            <!-- Divider -->
            <div class="h-1.5" style="background: linear-gradient(90deg, rgba(139,92,246,0.1) 0%, rgba(192,132,252,0.1) 100%);"></div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="form-group mb-0 md:col-span-2">
                        ...
                        <textarea wire:model="address"
                            class="form-control @error('address') !border-rose-400 @enderror"
                            rows="2" placeholder="Alamat tempat tinggal"></textarea>
