...
<body class="register-container">
    <div class="register-card">
        <div class="card p-0 overflow-hidden">
            <!-- Header -->
            <div class="form-section text-center" style="background: linear-gradient(135deg, rgba(139,92,246,0.05) 0%, rgba(192,132,252,0.05) 100%);">
            ...
            <form method="POST" action="{{ route('register') }}" id="registerForm">
                ...
                <div class="form-section">
                    <div class="flex items-center gap-3 mb-5 pb-4" style="border-bottom: 1px solid rgba(148,163,184,0.1);">
                    ...
                    <div class="role-selector">
                        <div class="role-option {{ old('role', 'intern') == 'intern' ? 'active' : '' }}" data-role="intern">
                            <div class="icon">
                        ...
                        <div class="role-option {{ old('role') == 'pembimbing' ? 'active' : '' }}" data-role="pembimbing">
                            <div class="icon">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="form-group mb-0 sm:col-span-2">
                            ...
                            <div class="search-input">
                                <input type="text" name="name" class="form-control @error('name') !border-rose-400 @enderror" 
                        ...
                        <div class="form-group mb-0 sm:col-span-2">
                            ...
                            <div class="search-input">
                                <input type="email" name="email" class="form-control @error('email') !border-rose-400 @enderror" 
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="password-wrapper">
                                <input type="password" name="password" id="password" class="form-control @error('password') !border-rose-400 @enderror" 
                ...
                <div id="internFields" class="form-section" style="{{ old('role', 'intern') == 'intern' ? '' : 'display: none;' }}">
                    <div class="flex items-center gap-3 mb-5 pb-4" style="border-bottom: 1px solid rgba(148,163,184,0.1);">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" name="nis" class="form-control @error('nis') !border-rose-400 @enderror" 
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="search-input">
                                <input type="text" name="phone" class="form-control @error('phone') !border-rose-400 @enderror" 
                        ...
                        <div class="form-group mb-0">
                            <label class="form-label">Asal Sekolah / Kampus <span class="text-rose-500">*</span></label>
                            <div class="search-input">
                                <input type="text" name="school" class="form-control @error('school') !border-rose-400 @enderror" 
                        ...
                        <div class="form-group mb-0">
                            <label class="form-label">Jurusan / Bidang Studi <span class="text-rose-500">*</span></label>
                            <div class="search-input">
                                <input type="text" name="department" class="form-control @error('department') !border-rose-400 @enderror" 
                        ...
                        <div class="form-group mb-0 sm:col-span-2">
                            ...
                            <textarea name="address" class="form-control @error('address') !border-rose-400 @enderror" 
                                rows="2" placeholder="Alamat tempat tinggal saat ini">{{ old('address') }}</textarea>
                        ...
                        <div class="form-group mb-0 sm:col-span-2">
                            ...
                            <div class="search-input">
                                <select name="supervisor_id" class="form-control @error('supervisor_id') !border-rose-400 @enderror">
                                    ...
                                    @foreach($supervisors as $supervisor)
                                        <option value="{{ $supervisor->user_id }}" {{ old('supervisor_id') == $supervisor->user_id ? 'selected' : '' }}>
                                            {{ $supervisor->user->name }} - {{ $supervisor->institution ?? 'Tidak ada instansi' }}
                                        </option>
                                    @endforeach
                                </select>
                                <i class="fas fa-chalkboard-teacher"></i>
                    ...
                    <div class="flex items-center gap-3 mb-5 mt-6 pb-4" style="border-bottom: 1px solid rgba(148,163,184,0.1);">
                        <div class="section-icon" style="background: rgba(34,197,94,0.1); color: #22c55e;">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="form-group mb-0">
                            ...
                            <input type="date" name="start_date" class="form-control @error('start_date') !border-rose-400 @enderror" 
                        ...
                        <div class="form-group mb-0">
                            ...
                            <input type="date" name="end_date" class="form-control @error('end_date') !border-rose-400 @enderror" 
                                value="{{ old('end_date') }}">
                ...
                <div id="pembimbingFields" class="form-section" style="{{ old('role') == 'pembimbing' ? '' : 'display: none;' }}">
                    <div class="flex items-center gap-3 mb-5 pb-4" style="border-bottom: 1px solid rgba(148,163,184,0.1);">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="form-group mb-0">
                            ...
                            <div class="search-input">
                                <input type="text" name="nip" class="form-control @error('nip') !border-rose-400 @enderror" 
                        ...
                        <div class="form-group mb-0">
                            <label class="form-label">WhatsApp / Telepon</label>
                            <div class="search-input">
                                <input type="text" name="supervisor_phone" class="form-control @error('supervisor_phone') !border-rose-400 @enderror" 
                                    value="{{ old('supervisor_phone') }}" placeholder="08xxxxxxxxxx">
                                <i class="fas fa-phone"></i>
                            </div>
                            @error('supervisor_phone') <span class="text-xs text-rose-500 mt-1 block">{{ $message }}</span> @enderror
                        </div>

                        <div class="form-group mb-0 sm:col-span-2">
                            <label class="form-label">Asal Instansi <span class="text-rose-500">*</span></label>
                            <div class="search-input">
                                <input type="text" name="institution" class="form-control @error('institution') !border-rose-400 @enderror" 
                                    value="{{ old('institution') }}" placeholder="Nama perusahaan / lembaga">
                                <i class="fas fa-building"></i>
                            </div>
                            @error('institution') <span class="text-xs text-rose-500 mt-1 block">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="form-group mb-0 sm:col-span-2">
                            ...
                            @error('supervisor_address') <span class="text-xs text-rose-500 mt-1 block">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section pt-0">
                    <div class="p-4 rounded-xl mb-5" style="background: rgba(139,92,246,0.05); border: 1px solid rgba(139,92,246,0.1);">
    ...
    <script>
        ...
        document.querySelectorAll('.role-option').forEach(option => {
            option.addEventListener('click', function() {
                ...
                document.getElementById('pembimbingFields').style.display = role === 'pembimbing' ? '' : 'none';

                // Toggle required fields
                const internRequired = document.querySelectorAll('#internFields input[name="school"], #internFields input[name="department"], #internFields input[name="start_date"], #internFields input[name="end_date"]');
